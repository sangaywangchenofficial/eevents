...
const WhyChooseUs = () => {
  return (
    <section className="py-20 bg-[#FAF8FF] relative overflow-hidden bhutan-pattern-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-[#475569] text-base mt-3 font-inter">
          ...
          {features.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/90 backdrop-blur-md rounded-2xl p-8 border border-purple-100 shadow-lg hover:shadow-2xl hover:shadow-purple-900/10 transition-all duration-300 group transform hover:-translate-y-1.5 flex flex-col justify-between"
              >
                <div>
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#6B21A8] to-[#8B5CF6] text-white flex items-center justify-center shadow-lg shadow-purple-500/20 group-hover:scale-110 transition-transform duration-300 mb-6">
                    <Icon className="w-7 h-7" />
                  </div>

                  <h3 className="font-poppins font-bold text-lg text-[#1E1B4B] tracking-wide mb-2 group-hover:text-[#6B21A8] transition-colors">
                    {feature.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-purple-50 flex items-center gap-2 text-xs font-poppins font-semibold text-[#8B5CF6]">
