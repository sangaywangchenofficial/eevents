...
import { isAuthenticated, APP_NAME_UPPER, APP_NAME_CAPITALIZED } from '../utils/auth';   // we only need isAuthenticated, not setAuth
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to "check your email" page, passing the email
  ...
  return (
    <PublicLayout>
      <SEO
        title={`Create Account | ${APP_NAME_CAPITALIZED}`}
        noindex={true}
        nofollow={true}
      />
      <div className="min-h-screen flex items-center justify-center bg-[#FDFDF7] dark:bg-[#0F1A17] p-4 py-12">
        ...
        <motion.div
          ...
          className="w-full max-w-lg bg-white dark:bg-[#1C2B27] rounded-3xl border border-[#E6E1D8] dark:border-[#2A3D38] shadow-2xl shadow-teal-900/8 p-8 sm:p-10 relative overflow-hidden"
        >
          {/* Header */}
          <div className="text-center mb-8">
            ...
            <p className="text-xs font-semibold text-[#1E8B7A] uppercase tracking-wider mt-1 flex items-center justify-center gap-1">
              ...
              <span>Join {APP_NAME_UPPER} Today</span>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-semibold text-[#1E352F] dark:text-[#E8F5F2] uppercase tracking-wider mb-1.5">
                  First Name
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 bg-[#FDFDF7] dark:bg-[#0F1A17] border border-[#E6E1D8] dark:border-[#2A3D38] rounded-xl text-[#1E352F] dark:text-[#E8F5F2] placeholder-[#66756F] dark:placeholder-[#7AA49D] focus:outline-none focus:border-[#29BBA3] focus:ring-1 focus:ring-[#29BBA3] transition-all text-sm"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-9 pr-4 py-2.5 bg-[#FDFDF7] dark:bg-[#0F1A17] border border-[#E6E1D8] dark:border-[#2A3D38] rounded-xl text-[#1E352F] dark:text-[#E8F5F2] placeholder-[#66756F] dark:placeholder-[#7AA49D] focus:outline-none focus:border-[#29BBA3] focus:ring-1 focus:ring-[#29BBA3] transition-all text-sm"
                />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-9 pr-10 py-2.5 bg-[#FDFDF7] dark:bg-[#0F1A17] border border-[#E6E1D8] dark:border-[#2A3D38] rounded-xl text-[#1E352F] dark:text-[#E8F5F2] placeholder-[#66756F] dark:placeholder-[#7AA49D] focus:outline-none focus:border-[#29BBA3] focus:ring-1 focus:ring-[#29BBA3] transition-all text-sm"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-[#66756F] dark:text-[#7AA49D] hover:text-[#29BBA3] transition-colors"
                  >
          ...
          {/* Login Callout */}
          <div className="mt-6 text-center pt-5 border-t border-[#E6E1D8] dark:border-[#2A3D38]">
            ...
            <div className="mt-3 inline-flex items-center gap-1.5 text-[11px] text-[#66756F] dark:text-[#7AA49D] font-medium">
