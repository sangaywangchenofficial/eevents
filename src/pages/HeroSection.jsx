...
const HeroSection = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FDFDF7] dark:bg-[#0F1A17] py-12 lg:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            {/* Top Pill / Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#E6F9F6] dark:bg-[#1C2B27] border border-[#C8EDE8] dark:border-[#2A3D38] text-[#1E8B7A] text-xs font-semibold tracking-wide uppercase shadow-sm">
            ...
            <h1 className="font-extrabold text-3xl sm:text-4xl lg:text-5xl text-[#1E352F] dark:text-[#E8F5F2] leading-[1.15] tracking-tight">
            ...
            {/* Supporting Subtitle */}
            <p className="text-base sm:text-lg text-[#4A5C57] dark:text-[#A8C4BE] max-w-2xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <form onSubmit={handleSearch} className="w-full max-w-xl mx-auto lg:mx-0 pt-2">
              <div className="glass-card dark:bg-[#1C2B27]/90 dark:border-[#2A3D38] p-2 rounded-2xl shadow-xl shadow-teal-900/8 border border-[#E6E1D8] dark:border-[#2A3D38] flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1 flex items-center pl-4">
                  ...
                  <input
                    ...
                    className="w-full py-3 bg-transparent text-[#1E352F] dark:text-[#E8F5F2] placeholder-[#66756F] dark:placeholder-[#7AA49D] focus:outline-none text-sm"
                  />
                </div>
                <button
                  type="submit"
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 pt-1">
              <span className="text-xs font-semibold text-[#66756F] dark:text-[#7AA49D] mr-1">Popular:</span>
              {popularTags.map((tag) => (
                <button
                  key={tag}
                  onClick={() => handleTagClick(tag)}
                  className="px-3 py-1 rounded-full text-xs font-medium bg-[#E6F9F6] dark:bg-[#1C2B27] text-[#1E8B7A] hover:bg-[#29BBA3] hover:text-white border border-[#C8EDE8] dark:border-[#2A3D38] transition-all duration-200"
                >
                  {tag}
                </button>
              ))}
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <button
                ...
                className="px-6 py-4 rounded-2xl border-2 border-[#E6E1D8] dark:border-[#2A3D38] hover:border-[#29BBA3] text-[#1E352F] dark:text-[#E8F5F2] hover:text-[#1E8B7A] font-semibold text-base transition-all hover:bg-[#E6F9F6] dark:hover:bg-[#162019] dark:bg-[#1C2B27] dark:hover:bg-[#162019] dark:bg-[#1C2B27]/50 dark:hover:bg-[#162019]/50"
              >
                Learn How It Works
              </button>
            </div>
            ...
            <div className="pt-6 border-t border-[#E6E1D8] dark:border-[#2A3D38] grid grid-cols-3 gap-4 max-w-lg mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                <p className="font-extrabold text-2xl text-[#1E352F] dark:text-[#E8F5F2]">50+</p>
                <p className="text-xs text-[#66756F] dark:text-[#7AA49D] font-medium">Annual Festivals</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="font-extrabold text-2xl text-[#29BBA3]">15,000+</p>
                <p className="text-xs text-[#66756F] dark:text-[#7AA49D] font-medium">Happy Attendees</p>
              </div>
              <div className="text-center lg:text-left">
                <p className="font-extrabold text-2xl text-[#1E352F] dark:text-[#E8F5F2]">100%</p>
                <p className="text-xs text-[#66756F] dark:text-[#7AA49D] font-medium">Digital & Verified</p>
              </div>
            </div>
          ...
          >
            ...
            {/* Laptop Mockup Box */}
            <div className="relative w-full max-w-md lg:max-w-lg glass-card rounded-3xl p-3 shadow-2xl shadow-teal-900/15 border border-[#E6E1D8] dark:border-[#2A3D38]">
