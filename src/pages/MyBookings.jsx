                ...
                <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-[#0F1A17] dark:via-[#0F1A17] dark:to-[#162019] py-8 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col justify-center items-center py-20">
                            ...
                            <p className="mt-6 text-gray-600 dark:text-[#7AA49D] font-medium">Loading your bookings...</p>
                        </div>
                    </div>
                </div>
            </PublicLayout>
                ...
                <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-[#0F1A17] dark:via-[#0F1A17] dark:to-[#162019] py-8 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="bg-white dark:bg-[#1C2B27] rounded-2xl shadow-xl p-8 text-center max-w-md mx-auto border-l-4 border-red-500">
                            ...
                            <h3 className="text-xl font-bold text-gray-800 dark:text-[#E8F5F2] mb-2">Error Loading Bookings</h3>
                            <p className="text-gray-600 dark:text-[#7AA49D] mb-6">{error}</p>
                            <button
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    {myBookings.length > 0 ? (
                        <div className="space-y-6">
                            <div className="bg-white dark:bg-[#1C2B27] rounded-2xl shadow-lg p-6 border border-gray-100 dark:border-[#2A3D38] backdrop-blur-sm bg-white dark:bg-[#1C2B27]/90">
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    <div className="text-center">
                                        <p className="text-sm text-gray-500 dark:text-[#7AA49D] font-medium">Total Bookings</p>
                                        <p className="text-3xl font-bold text-blue-600 mt-1">{myBookings.length}</p>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-sm text-gray-500 dark:text-[#7AA49D] font-medium">Upcoming Events</p>
                                        <p className="text-3xl font-bold text-green-600 mt-1">
                                            {myBookings.filter(b => new Date(b.event?.event_date) > new Date()).length}
                                        </p>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-sm text-gray-500 dark:text-[#7AA49D] font-medium">Past Events</p>
                                        <p className="text-3xl font-bold text-gray-600 dark:text-[#7AA49D] mt-1">
                                            {myBookings.filter(b => new Date(b.event?.event_date) < new Date()).length}
                                        </p>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-sm text-gray-500 dark:text-[#7AA49D] font-medium">Total Spent</p>
                            ...
                            <div className="space-y-6">
                                {myBookings.map((booking, index) => (
                                    <motion.div
                                        ...
                                        className="group bg-white dark:bg-[#1C2B27] rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 dark:border-[#2A3D38] backdrop-blur-sm bg-white dark:bg-[#1C2B27]/95"
                                    >
                                            ...
                                            <div className="flex-1 p-6">
                                                <div className="flex flex-col h-full">
                                                    <div className="flex-1">
                                                        <h2 className="text-xl font-bold text-gray-800 dark:text-[#E8F5F2] group-hover:text-blue-600 transition-colors duration-200 mb-2">
                                                            {booking.event?.event_name || 'Event Name Unavailable'}
                                                        </h2>

                                                        <p className="text-gray-600 dark:text-[#7AA49D] text-sm mb-4 line-clamp-2">
                                                            {booking.event?.event_description || 'No description available'}
                                                        </p>

                                                        <div className="grid grid-cols-2 gap-3 mb-4">
                                                            <div className="flex items-center space-x-2 text-sm text-gray-600 dark:text-[#7AA49D]">
                                                        ...
                                                        <div className="text-sm text-gray-500 dark:text-[#7AA49D] mb-3">
                                                            Booked on: {booking.booking_date_formatted || formatDate(booking.booking_date)}
                                                        </div>
                                                    </div>

                                                    <div className="border-t border-gray-200 dark:border-[#2A3D38] pt-4 mt-2">
                                                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                                            <div className="flex items-baseline space-x-2">
                                                                ...
                                                                <span className="text-sm text-gray-500 dark:text-[#7AA49D]">total</span>
                                                            </div>
                                                            <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="flex-1 sm:flex-none px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border-2 border-red-200 dark:border-red-800 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 hover:border-red-500 transition-all duration-200 text-sm font-medium"
                                                                >
                                                                    Cancel
                                                                </button>
                                                            </div>
                        ...
                        <div className="bg-white dark:bg-[#1C2B27] rounded-2xl shadow-xl p-12 text-center max-w-2xl mx-auto border border-gray-100 dark:border-[#2A3D38]">
                            ...
                            <h2 className="text-3xl font-bold text-gray-800 dark:text-[#E8F5F2] mb-3">No Bookings Found</h2>
                            <p className="text-gray-600 dark:text-[#7AA49D] mb-8 max-w-md mx-auto">
